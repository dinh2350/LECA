...
async function PrivacyPolicy(props: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-3">{t('interpretation')}</h3>
      <p className="mb-4">{t('interpretation_description')}</p>
      <h3 className="text-xl font-semibold mt-6 mb-3">{t('definitions')}</h3>
      ...
      <ul className="list-disc pl-8 mb-6 space-y-2">
        ...
        <li>
          ...
          <ExternalLink href="https://react-boilerplate-coral.vercel.app/">
      ...
      <h4 className="text-lg font-semibold mb-3">{t('personal_data')}</h4>
      <p className="mb-4">{t('personal_data_description')}</p>
      <ul className="list-disc pl-8 mb-4">
        <li>{t('usage_data')}</li>
      </ul>
      <h4 className="text-lg font-semibold mb-3">{t('usage_data')}</h4>
      ...
      <ul className="list-disc pl-8 mb-4 space-y-4">
        <li>
          <p className="font-bold mb-1">{t('necessary_cookies_title')}</p>
          <p className="mb-1">{t('session_cookies')}</p>
          <p className="mb-1">{t('administered_by')}</p>
          <p>{t('necessary_cookies_purpose')}</p>
        </li>
        <li>
          <p className="font-bold mb-1">{t('cookies_policy_title')}</p>
          <p className="mb-1">{t('persistent_cookies')}</p>
          <p className="mb-1">{t('administered_by')}</p>
          <p>{t('cookies_policy_purpose')}</p>
        </li>
        <li>
          <p className="font-bold mb-1">{t('functionality_cookies_title')}</p>
          <p className="mb-1">{t('persistent_cookies')}</p>
          <p className="mb-1">{t('administered_by')}</p>
      ...
      <h2 className="text-2xl font-semibold mt-10 mb-6">{t('contact_us')}</h2>
      <p className="mb-4">{t('contact_us_paragraph')}</p>
      <ul className="list-disc pl-8 mb-4 space-y-2">
        <li>
          {t('contact_us_by_email')}{' '}
          <ExternalLink href="mailto:boilerplates@brocoders.com">
            boilerplates@brocoders.com
          </ExternalLink>
        </li>
        <li>
          {t('contact_us_on_website')}{' '}
          <ExternalLink href="https://bcboilerplates.com/">
            bc boilerplates
          </ExternalLink>
        </li>
        <li>
          {t('contact_us_on_github_discussions')}{' '}
          <ExternalLink href="https://github.com/brocoders/nestjs-boilerplate/discussions">
            nestjs-boilerplate
          </ExternalLink>{' '}
          {t('contact_us_on_github_discussions_or')}{' '}
          <ExternalLink href="https://github.com/brocoders/extensive-react-boilerplate/discussions">
            extensive-react-boilerplate
          </ExternalLink>
        </li>
        <li>
          {t('contact_us_on_discord')}{' '}
          <ExternalLink href="https://discord.com/channels/520622812742811698/1197293125434093701">
            channel
          </ExternalLink>
        </li>
      </ul>
